...
namespace Web_QuanLyNhaHang
{
    public partial class BanHang : Form
    {
        ...
        {
            InitializeComponent();
            datamonan.CellClick += datamonan_CellClick;
        }
        ...
        private void datamonan_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (datamonan.CurrentRow != null && datamonan.CurrentRow.Cells[1].Value != null)
                {
        ...
        private void xongdon_Click(object sender, EventArgs e)
        {
            mahoadon = null;
            mamonan = null;
            datacthd.Rows.Clear();
